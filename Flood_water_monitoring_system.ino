...
LiquidCrystal_I2C lcd(0x27, 16, 2);
 char auth[] = "2ijmYCgXBY_6LcEHb6mxg6Y-Mx5KgRkL";//Enter your Auth token
char ssid[] = "T&B 305";//Enter your WIFI name
char pass[] = "8888a8888";//Enter your WIFI password
BlynkTimer timer;
#define BLYNK_TEMPLATE_ID "TMPL68QMmqPOw"
#define BLYNK_TEMPLATE_NAME "Flood water level monitoring system"
